        ...
        <header class="topbar">
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header">
                    <a class="navbar-brand" href="ticketA.php">
                        <b>
                                            ...
                                            <?php
												...
												$idx = $dadin['ID'];?>
													<tr>
														...
														<td><a href="user.html"><img src="assets/images/edit.jpeg" width=45
																height=40></a></td>
														<td><img src="assets/images/delete.jpeg" width=45
																height=40 onclick="confirmDelete(\'este usuário\')"></td>
													</tr>
												<?}?>                                           
                                        </tbody>
                                    </table>
