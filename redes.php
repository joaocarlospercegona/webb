...
<html>
	...
	<title> Cabal The Last War</title>
		...
		*{
		...
		body{
	margin: 0;
	background:url(img/Redes1.png) center no-repeat;
...
<nav class="menu">
	...
	<div class="login">
			...
			<input type="submit" class="esp" style="border-radius:10px; width:50px; height:40px ;background-color: #00BFFF; color: white;" value="Logar"/>
				...
				<div class="absolute">
					<a href=""><img src="img/facebook.png"  width="55px"/> Facebook </a>
					<a href=""><img src="img/whats.png"  width="55px"/> Whatsapp</a>
					<a href=""><img src="img/instagram.png"  width="55px"/> Instagram</a>
					<a href=""><img src="img/discordi.png"  width="55px"/> Discord</a>
					<a href=""><img src="img/youtube1.png" width="55px"/> Youtube</a>
				</div>
	</Body>
</html>
